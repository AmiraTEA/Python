...
result_s_root1 = pow(item_2, 0.5)
result_s_root2 = item_2 ** .5
# 14. Вывести result_s_root1 в консоль.
print('Result_s_root1 = ', result_s_root1)
print('Result_s_root2 = ', result_s_root2)
...
result_mp_s_root = math.pow(item_2, 1/2)   # math.pow(x, 1/n)
# 18. Вывести result_m_s_root в консоль.
...
result_division = item_1 / item_2  # В остатке выводится float
...
print('Result_int = ', result_m_ceil)
...
item_3 **= 0.5
# 43. Вывести item_3 в консоль.
print('Result_item_3 **1/2= ', item_3)
...
print('Result_b_item_relult_sum = ', b_item_relult_sum)
...
print('Result_b_item_relult_subtr = ', b_item_relult_subtr)
...
print('Result_b_item_relult_multi = ', b_item_relult_multi)
...
# print('Result_b_item_relult_division = ', b_item_relult_division)
...
print('Result_b_item_1_int = ', b_item_1_int)

# 60. Создать переменную b_item_2_int и присвоить явное приведение b_item_2 к int
b_item_2_int = int(b_item_f)
# 59. Вывести b_item_2_int в консоль..
print('Result_b_item_2_int = ', b_item_2_int)
